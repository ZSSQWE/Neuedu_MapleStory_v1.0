...
/**
 * 
* @ClassName: BossSkill3
* @Description: TODO(boss技能3)
* @author 张盛爽
* @date 2019年8月26日
*
 */
public class BossSkill3 extends MapleStoryObject {
	/**
	 * 图片类型数组
	 */
	...
	static {
		// skill3
		for (int i = 0; i < 17; i++) {
			images[i] = imageUtil.getimage("boss_skill3_l" + i);
		}
		for (int i = 17; i < 34; i++) {
			images[i] = imageUtil.getimage("boss_skill3_r" + (i - 17));
		}
	}
	/**
	    * 构造方法
	...
	/**
	    ...
	    * @param dir 方向
	    */
	public BossSkill3(MapleStoryClient msc, int x, int y, Direction dir) {
		this.msc = msc;
		this.x = x;
		this.y = y;
